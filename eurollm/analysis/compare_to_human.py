...
def run_figure(
    ...
    if figure in (*report_figs, "umap_grid"):
        print("\n  Generating UMAP Grid (2×3: metric × filter)...")
        try:
    ...
    # Supplementary figures only when running "all"
    if figure == "all":
...
def main():
    ...
    parser.add_argument("--figure", type=str, default="all",
                        choices=["all", "report", "umap_grid", "iw", "scatter", "heatmap", "jsd_dist", "deepdive"],
